...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write("Creating warehouse items...")
        WarehouseItem.objects.create(
            code=str(uuid.uuid4()),
            location=WarehouseLocation.objects.get(code="AA-01-01"),
            stock_product=StockProduct.objects.get(code="021729-0401-10"),
            amount=1,
            package_type=PackageType.objects.get(name="B0100"),
        )
