...
import type { ProductTypeCreateOrUpdateSchema } from '@/client'
import { rules } from '@/utils/rules'

const showDialog = defineModel<boolean>('show', { default: false })
const form = defineModel<ProductTypeCreateOrUpdateSchema>({ required: true })
...
const emit = defineEmits<{
  (e: 'submit', body: ProductTypeCreateOrUpdateSchema): void
}>()
