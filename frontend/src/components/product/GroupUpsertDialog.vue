...
import type { ProductGroupCreateOrUpdateSchema } from '@/client'
import { rules } from '@/utils/rules'

const showDialog = defineModel<boolean>('show', { default: false })
const form = defineModel<ProductGroupCreateOrUpdateSchema>({ required: true })
...
const emit = defineEmits<{
  (e: 'submit', body: ProductGroupCreateOrUpdateSchema): void
}>()
