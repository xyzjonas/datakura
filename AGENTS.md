...
- Always use ONLY the autogenerated SDK from Hello API: '@/client/sdk.gen' (no raw fetching nor direct usage of hello API `client`)
...
After every work item, plain `just` has to pass (it includes all the CI checks)!
